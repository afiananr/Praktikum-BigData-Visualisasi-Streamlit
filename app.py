...
st.markdown("Oleh: Afiana Nurani (NPM: 23082010162)")
...
if clean_data:
    ...
    df_display['Jumlah_Penduduk'] = df_display['Jumlah_Penduduk'].fillna(
        df_display['Jumlah_Penduduk'].median()
    )

    df_display.loc[df_display['Suhu_Udara'] > 50, 'Suhu_Udara'] = \
        df_display[df_display['Suhu_Udara'] < 50]['Suhu_Udara'].mean()
...
with col3:
    ...
    fig_null = px.bar(
        ...
        labels={'x': 'Kolom', 'y': 'Jumlah Kosong'}
    )
